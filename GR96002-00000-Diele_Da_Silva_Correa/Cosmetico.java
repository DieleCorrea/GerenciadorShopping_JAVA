public class Cosmetico extends Loja{
    ...
    public Cosmetico(String nome, int quantidadeFuncionarios, int salarioBaseFuncionario, Endereco endereco, Data dataFundacao, double taxaComercializacao, int qtdMaxProdutos) {
